  ...
  <div class="content">
    ...
    <div class="page-hd">
      <div class="page-hd-left">
        <div class="page-label">{{ __('Activity') }}</div>
        <h1>{{ __('All Notifications') }}</h1>
        <div class="page-sub">{{ __('Donor responses, request status updates, and fulfillment activity.') }}</div>
      </div>
    ...
    <div class="filter-tabs">
      <a href="{{ route('hospital.notifications.index') }}" class="ftab {{ request('status') !== 'unread' ? 'active' : '' }}">{{ __('All') }}</a>
      <a href="{{ route('hospital.notifications.index', ['status' => 'unread']) }}" class="ftab {{ request('status') === 'unread' ? 'active' : '' }}">{{ __('Unread') }}</a>
    </div>
