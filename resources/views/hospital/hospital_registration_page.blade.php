...
<nav>
  ...
  <div class="nav-right">Already registered? <a href="{{ route('hospital.login') }}">Sign In →</a></div>
</nav>
...
<div class="page">
  ...
  <div class="left-panel">
    <div>
      <div class="panel-badge"><span></span> Hospital Portal</div>
      <h2>Connect your hospital with LifeLink's donor network</h2>
      <p>Register your hospital to submit blood requests and reach an AI-ranked pool of eligible, compatible donors in minutes.</p>

      <div class="benefit-list">
        <div class="benefit">
          <svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
          <div>
            <div class="benefit-t">AI-ranked donor matching</div>
            <div class="benefit-s">Blood/Rh compatibility, proximity, and donor reliability, weighted by urgency.</div>
          </div>
        </div>
        <div class="benefit">
          <svg viewBox="0 0 24 24"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
          <div>
            <div class="benefit-t">Track requests end-to-end</div>
            <div class="benefit-s">From submission to fulfilment, all in one dashboard.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="verify-note">
      New hospital accounts start <strong>unverified</strong> and are reviewed by a LifeLink administrator. You can submit requests right away while verification is pending.
    </div>
  </div>
  ...
  <div class="form-area">
    <div class="form-card">
      <div class="form-header">
        ...
        <p>Create a hospital account to start submitting blood requests.</p>
      </div>
      ...
      <form method="POST" action="{{ route('hospital.register') }}">
        ...
        <button type="submit" class="submit-btn">Create Hospital Account</button>
      </form>

      <div class="login-link">
        Already registered? <a href="{{ route('hospital.login') }}">Sign in →</a>
      </div>
    </div>
  </div>
</div>
