...
<div class="main">
  ...
  <div class="topbar">
    <div class="tb-left">
      ...
      <div class="tb-title">Inventory History</div>
    </div>
    <div class="tb-right">
  ...
  <div class="content">
    ...
    <div class="page-hd">
      <div class="page-hd-left">
        <div class="page-label">Reports</div>
        <h1>Inventory Change History</h1>
      </div>
      <a href="{{ route('hospital.inventory.index') }}" class="btn-back">← Back to Inventory</a>
    </div>
    ...
    <div class="table-card">
        ...
        <table>
          ...
          <tbody>
            ...
            @empty
              <tr>
                <td colspan="7">
                  <div class="empty-state">No inventory changes recorded yet.</div>
                </td>
              </tr>
            @endforelse
          </tbody>
      ...
      @if($logs->hasPages())
        <div class="pagination-wrap">
          <div class="page-info">
            Showing {{ $logs->firstItem() }}–{{ $logs->lastItem() }} of {{ $logs->total() }} changes
          </div>
