...
<div class="main">
  ...
  <div class="topbar">
    <div class="tb-left">
      ...
      <div class="tb-title">{{ __('Blood Inventory') }}</div>
    </div>
    <div class="tb-right">
      <div class="hosp-pill">
  ...
  <div class="content">
    ...
    <div class="page-hd">
      <div class="page-hd-left">
        ...
        <h1>{{ __('Blood Stock Levels') }}</h1>
      </div>
      <a href="{{ route('hospital.inventory.history') }}" class="btn-history">{{ __('View History →') }}</a>
    </div>
    ...
    <div class="stat-row">
      <div class="sc">
        ...
        <div class="sc-label">{{ __('Total Units in Stock') }}</div>
      </div>
      <div class="sc">
        <div class="sc-top">
        ...
        <div class="sc-label">{{ __('Blood Groups Low on Stock') }}</div>
      </div>
      <div class="sc">
        <div class="sc-top">
        ...
        <div class="sc-label">{{ __('Critical Blood Groups') }}</div>
      </div>
    </div>
                ...
                <td>
                  <div class="actions-cell">
                    <form method="POST" action="{{ route('hospital.inventory.add', $item->id) }}" class="mini-form">
                      @csrf
                      <input type="number" name="units" min="1" max="500" value="1" class="mini-input" aria-label="{{ __('Units to add') }}">
                      <button type="submit" class="mini-btn add">+ {{ __('Add') }}</button>
                    </form>
                    <form method="POST" action="{{ route('hospital.inventory.remove', $item->id) }}" class="mini-form">
                      @csrf
                      <input type="number" name="units" min="1" max="500" value="1" class="mini-input" aria-label="{{ __('Units to remove') }}">
                      <button type="submit" class="mini-btn remove">− {{ __('Remove') }}</button>
                    </form>
                    <form method="POST" action="{{ route('hospital.inventory.threshold', $item->id) }}" class="mini-form">
                      @csrf
                      <input type="number" name="minimum_threshold" min="0" max="1000" value="{{ $item->minimum_threshold }}" class="mini-input" aria-label="{{ __('Minimum threshold') }}">
                      <button type="submit" class="mini-btn threshold">{{ __('Set Min') }}</button>
                    </form>
                  </div>
                </td>
              </tr>
