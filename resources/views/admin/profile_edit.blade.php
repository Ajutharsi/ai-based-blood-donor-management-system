...
<div class="main">
  ...
  <div class="topbar">
    <div class="topbar-left">
      ...
      <div class="topbar-title">{{ __('Settings') }}</div>
    </div>
  ...
  <div class="content">
    ...
    <div class="card">
      <div class="card-t">{{ __('Admin Account') }}</div>
      <div class="card-s">{{ __('Update your administrator name, email, or password.') }}</div>
      ...
      <form method="POST" action="{{ route('admin.profile.update') }}">
        ...
        <div class="section-divider">{{ __('Change Password (optional)') }}</div>
        ...
        <div class="actions">
          ...
          <a href="{{ route('admin.dashboard') }}" class="btn-cancel">{{ __('Cancel') }}</a>
        </div>
      </form>
    </div>
  </div>
