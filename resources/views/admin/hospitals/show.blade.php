<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .b-urgency-critical{background:var(--red-light);color:var(--red-dark);}
...
<div class="main">
  ...
  <div class="topbar">
    <div class="topbar-left">
      ...
      <div class="topbar-title">Hospital Profile</div>
    </div>
    ...
    <div class="page-grid">
      ...
      <div>
        <div class="profile-card">
          ...
          <div class="pc-body">
            ...
            <div class="pc-row">
              <span class="pc-key">Registration ID</span>
            ...
            <div class="pc-row">
              <span class="pc-key">Address</span>
          ...
          <div class="action-btns">
            ...
            <form method="POST" action="{{ route('admin.hospitals.toggle', $hospital->id) }}" style="margin:0;">
              ...
              <button type="submit"
                ...
                {{ $hospital->is_verified ? 'Mark as Unverified' : 'Verify Hospital' }}
              </button>
            </form>
            ...
            <form method="POST" action="{{ route('admin.hospitals.destroy', $hospital->id) }}" style="margin:0;">
              ...
              <button type="submit"
                      ...
                      onclick="return confirm('Permanently delete {{ $hospital->name }}? This will also delete all of their blood requests. This cannot be undone.')">
      ...
      <div>
        ...
        <div class="card">
          <div class="card-hd">
            <div>
              <div class="card-t">Overview</div>
              <div class="card-s">Blood request activity for this hospital</div>
            </div>
          </div>
          <div class="info-grid">
            <div class="info-item">
              <div class="info-key">Total Requests</div>
              <div class="info-val large">{{ $hospital->bloodRequests->count() }}</div>
            </div>
            <div class="info-item">
              <div class="info-key">Pending</div>
              <div class="info-val large">{{ $hospital->bloodRequests->where('status', 'pending')->count() }}</div>
            </div>
            <div class="info-item">
              <div class="info-key">Fulfilled</div>
              <div class="info-val large">{{ $hospital->bloodRequests->where('status', 'fulfilled')->count() }}</div>
            </div>
            <div class="info-item">
              <div class="info-key">Critical Requests</div>
        ...
        <div class="card">
          <div class="card-hd">
            <div>
              <div class="card-t">Blood Request History</div>
              <div class="card-s">{{ $hospital->bloodRequests->count() }} recorded request{{ $hospital->bloodRequests->count() !== 1 ? 's' : '' }}</div>
            </div>
          </div>
          ...
          @else
            <div class="notes-box">No blood requests submitted yet.</div>
          @endif
        </div>
