  ...
  <div class="content">
    ...
    <div class="page-hd">
      ...
      <span style="font-size:0.82rem;color:var(--muted);">
        {{ $hospitals->total() }} hospital{{ $hospitals->total() !== 1 ? 's' : '' }} found
      </span>
    </div>
    ...
    <form method="GET" action="{{ route('admin.hospitals.index') }}">
      <div class="filter-bar">
        ...
        <a href="{{ route('admin.hospitals.index') }}" class="btn-reset">Reset</a>
      </div>
    </form>
    ...
    <div class="table-card">
            ...
            @forelse($hospitals as $hospital)
              <tr>
                ...
                <td>
                  <div class="actions">
                    {{-- VIEW --}}
                    <a href="{{ route('admin.hospitals.show', $hospital->id) }}" class="btn-view">View</a>
                    ...
                    <form method="POST" action="{{ route('admin.hospitals.toggle', $hospital->id) }}" style="margin:0;">
                      ...
                      <button type="submit"
                              ...
                              onclick="return confirm('{{ $hospital->is_verified ? 'Mark as unverified?' : 'Verify this hospital?' }}')">
                    ...
                    <form method="POST" action="{{ route('admin.hospitals.destroy', $hospital->id) }}" style="margin:0;">
                      ...
                      <button type="submit" class="btn-delete"
                              onclick="return confirm('Delete {{ $hospital->name }}? This cannot be undone.')">
                        Delete
                      </button>
                    </form>
                  </div>
      ...
      @if($hospitals->hasPages())
        <div class="pagination-wrap">
          <div class="page-info">
            Showing {{ $hospitals->firstItem() }}–{{ $hospitals->lastItem() }} of {{ $hospitals->total() }} hospitals
          </div>
