<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .btn-filter{padding:0.5rem 1.1rem;border:none;border-radius:8px;background:var(--red);color:white;font-family:'DM Sans',sans-serif;font-size:0.8rem;font-weight:500;cursor:pointer;}
  ...
  tbody tr{border-bottom:1px solid rgba(200,25,42,0.06);}
  ...
  .b-anom{background:var(--red-light);color:var(--red-dark);}
  .b-other{background:var(--gray);color:var(--muted);}
  .donor-link{color:var(--red-dark);text-decoration:none;font-weight:500;}
...
<div class="main">
  ...
  <div class="topbar">
    <div class="topbar-left">
      ...
      <div class="topbar-title">AI Predictions</div>
    </div>
  ...
  <div class="content">
    ...
    <div class="page-hd">
      ...
      <h1>AI Prediction History</h1>
      <div class="page-sub">Every AI call the system has made — eligibility, response, and anomaly checks — with the model, input, output, and confidence recorded at the time.</div>
    </div>
    ...
    <form method="GET" action="{{ route('admin.ai-predictions.index') }}">
      <div class="filter-bar">
        ...
        <a href="{{ route('admin.ai-predictions.index') }}" class="btn-reset">Reset</a>
      </div>
    </form>
        ...
        <table>
          ...
          <tbody>
            @forelse($predictions as $p)
              <tr>
                ...
                <td>
                  ...
                  @else
                    <span style="color:var(--muted);">Deleted donor</span>
                  @endif
                </td>
                <td>
            ...
            @empty
              <tr>
                <td colspan="6">
                  <div class="empty-state">No AI predictions recorded yet.</div>
                </td>
              </tr>
            @endforelse
          </tbody>
