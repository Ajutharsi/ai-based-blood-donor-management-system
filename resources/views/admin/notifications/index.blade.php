...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="page-hd">
      <div>
        <div class="page-label">System Alerts</div>
        <h1>All Notifications</h1>
        <div class="page-sub">New hospital registrations, critical blood shortages, and AI anomaly alerts.</div>
      </div>
    ...
    <div class="filter-pills">
      <a href="{{ route('admin.notifications.index') }}" class="fpill {{ request('status') !== 'unread' ? 'active' : '' }}">All</a>
      <a href="{{ route('admin.notifications.index', ['status' => 'unread']) }}" class="fpill {{ request('status') === 'unread' ? 'active' : '' }}">Unread</a>
    </div>
