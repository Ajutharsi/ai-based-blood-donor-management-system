  ...
  <div class="topbar">
    <div class="tb-left">
      <div>
        ...
        <div class="tb-sub">Blood request matches, eligibility, and account updates</div>
      </div>
    </div>
    <div class="tb-right">
  ...
  <div class="content">
    ...
    <div class="page-hd">
      <div>
        ...
        <div class="page-sub">Every alert LifeLink has sent you, newest first.</div>
      </div>
    ...
    <div class="filter-tabs">
      <a href="{{ route('donor.notifications.index') }}" class="ftab {{ request('status') !== 'unread' ? 'active' : '' }}">All</a>
      <a href="{{ route('donor.notifications.index', ['status' => 'unread']) }}" class="ftab {{ request('status') === 'unread' ? 'active' : '' }}">Unread</a>
    </div>
