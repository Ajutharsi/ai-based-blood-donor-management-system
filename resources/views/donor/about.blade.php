...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    /* ── HERO ── */
    .hero{padding:140px 5% 80px;background:linear-gradient(160deg,#1A0A0B 0%,var(--red-dark) 60%,#3D0A11 100%);position:relative;overflow:hidden;}
    ...
    .section-tag{font-size:0.7rem;font-weight:600;color:var(--red);letter-spacing:0.12em;text-transform:uppercase;margin-bottom:0.75rem;}
    ...
    .mv-big-num{font-family:'Playfair Display',serif;font-size:5rem;font-weight:900;color:var(--red-light);line-height:1;margin-bottom:0.5rem;}
    .mv-big-num span{color:var(--red);}
    ...
    .mv-stat-icon{width:38px;height:38px;background:var(--red-light);border-radius:9px;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
    .mv-stat-icon svg{width:18px;height:18px;stroke:var(--red);}
    ...
    .value-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:var(--red);transform:scaleX(0);transform-origin:left;transition:transform 0.3s;}
    .value-card:hover::before{transform:scaleX(1);}
    .value-card:hover{transform:translateY(-4px);box-shadow:0 12px 40px rgba(200,25,42,0.1);}
    .vc-num{font-family:'Playfair Display',serif;font-size:2.5rem;font-weight:900;color:var(--red-light);margin-bottom:0.75rem;line-height:1;}
    .vc-num span{color:var(--red);}
    ...
    .tc-av1{background:linear-gradient(135deg,#C8192A,#8B0F1C);}
    ...
    .tc-role{font-size:0.75rem;color:var(--red);font-weight:500;margin-bottom:0.5rem;}
    ...
    .tech-card:hover{border-color:var(--red-mid);background:var(--red-light);}
    ...
    .timeline::before{content:'';position:absolute;left:0;top:0;bottom:0;width:2px;background:var(--red-mid);}
    .tl-item{position:relative;padding-bottom:2rem;}
    .tl-item:last-child{padding-bottom:0;}
    .tl-dot{position:absolute;left:-2.4rem;top:0.2rem;width:14px;height:14px;background:var(--red);border-radius:50%;border:3px solid white;box-shadow:0 0 0 2px var(--red-mid);}
    .tl-year{font-size:0.72rem;font-weight:700;color:var(--red);letter-spacing:0.06em;text-transform:uppercase;margin-bottom:0.3rem;}
  ...
  .logo{display:flex;align-items:center;gap:10px;font-family:'Playfair Display',serif;font-size:1.25rem;font-weight:700;color:var(--red-dark);}
  .logo-icon{width:34px;height:34px;background:var(--red);border-radius:50%;display:flex;align-items:center;justify-content:center;}
  ...
  .btn-ghost{padding:0.5rem 1.25rem;border:1px solid var(--border);border-radius:6px;background:transparent;color:var(--red-dark);font-family:'DM Sans',sans-serif;font-size:0.875rem;cursor:pointer;transition:all 0.2s;}
  .btn-ghost:hover{background:var(--red-light);}
  .btn-primary{padding:0.5rem 1.25rem;border:none;border-radius:6px;background:var(--red);color:white;font-family:'DM Sans',sans-serif;font-size:0.875rem;font-weight:500;cursor:pointer;transition:all 0.2s;}
  .btn-primary:hover{background:var(--red-dark);}
  </style>
</head>
<body>
