...
<div class="main">
  ...
  <div class="topbar">
    <div class="tb-left">
      <div>
        <div class="tb-title">Donation Appointments</div>
        <div class="tb-sub">Book, track, and manage your donation appointments</div>
      </div>
    </div>
    <div class="tb-right">
  ...
  <div class="content">
    ...
    <div class="section-sub">Only requests you responded "Available" to can be booked.</div>
    @if($bookableRequests->isEmpty())
      <div class="empty-state">
        <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        <h3>No Bookable Requests Right Now</h3>
        <p>Respond "Available" to a blood request from the Blood Requests page to unlock booking here.</p>
      </div>
    @else
      <div class="apt-list">
          ...
          <div class="apt-card">
            <div class="apt-top">
              ...
              <div class="apt-info">
                ...
                <div class="apt-meta">{{ $r->units_needed }} unit{{ $r->units_needed > 1 ? 's' : '' }} needed @if($r->ward) · {{ $r->ward }} @endif</div>
              </div>
            </div>
            <form method="POST" action="{{ route('donor.appointments.store', $r->id) }}" class="book-form">
              ...
              <div class="book-field" style="flex:1;min-width:160px;">
                ...
                <input type="text" name="notes" placeholder="Any note for the hospital">
              </div>
    ...
    @if($upcoming->isEmpty())
      <div class="empty-state">
        ...
        <p>Once you book an appointment, it will appear here pending hospital approval.</p>
      </div>
    @else
      <div class="apt-list">
          ...
          <div class="apt-card">
            <div class="apt-top">
              ...
              <div class="apt-info">
                ...
                <div class="apt-meta">{{ $a->appointment_date->format('d M Y') }} at {{ $a->appointment_time }}</div>
              </div>
    ...
    @if($history->isEmpty())
      <div class="empty-state">
        ...
        <p>Completed, rejected, and cancelled appointments will show up here.</p>
      </div>
    @else
      <div class="apt-list">
