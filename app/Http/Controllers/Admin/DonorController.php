...
class DonorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Search by name or email. LIKE wildcard characters are stripped
        // from the input first so a search for "%" or "_" can't turn into
        // an unintended match-everything/broad-match pattern.
    ...
    public function toggleEligibility(Donor $donor)
    {
        ...
        ActivityLog::log(
            'admin', 'donor_eligibility_toggled',
            __('Admin marked :donor as :status.', ['donor' => $donor->full_name, 'status' => $donor->is_eligible ? 'eligible' : 'not eligible']),
            'Donor', $donor->id
        );
    ...
    public function storeDonation(Request $request, Donor $donor)
    {
        ...
        ActivityLog::log(
            ...
            __('Admin recorded a donation for :donor.', ['donor' => $donor->full_name]),
    ...
    public function destroy(Donor $donor)
    {
        ...
        ActivityLog::log('admin', 'donor_deleted', __('Admin deleted donor :name.', ['name' => $name]), 'Donor', $id);
